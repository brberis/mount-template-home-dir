...
# It installs NVIDIA drivers, Singularity, Jupyter launcher, AND sets up reliable shared folders
...
####################
# SINGULARITY INSTALLATION (ORIGINAL)
####################
...
sudo apt-get install -y build-essential libssl-dev uuid-dev libgpgme11-dev \
    squashfs-tools libseccomp-dev pkg-config wget git cryptsetup debootstrap \
...
main() {
    ...
    echo "✅ Firefox: Installed from PPA"
    echo "✅ Singularity: Installed and ready"
    echo "✅ Jupyter launcher: Created"
    echo "✅ Local shared directories: $LOCAL_SHARED_BASE"
    echo "✅ External NFS: Configured (fallback available)"
    echo "✅ User directory service: Running"
    echo "✅ CPU limiting: ${CPU_LIMIT}% per user"
    echo "✅ Update prompts: Disabled"
    echo ""
    ...
    echo ""
    echo "👨‍🏫 For instructor ($TARGET_USER):"
